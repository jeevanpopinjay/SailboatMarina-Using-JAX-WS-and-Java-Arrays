...
public class ObjectFactory {
    ...
    private final static QName _HelloWorld_QNAME = new QName("http://jaxws/", "helloWorld");
    private final static QName _HelloWorldResponse_QNAME = new QName("http://jaxws/", "helloWorldResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws/", name = "helloWorld")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://jaxws/", name = "helloWorldResponse")
