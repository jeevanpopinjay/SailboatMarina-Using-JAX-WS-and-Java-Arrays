 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://jaxws/", wsdlLocation = "http://localhost:8081/WS/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://jaxws/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8005/WS/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://jaxws/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
